...
if (typeof location !== 'undefined' && (location.hostname === 'nsumint.ru' || location.hostname === '127.0.0.1')) {
  Ember.Logger.warn("You are running a production build of Ember on nsumint.ru and won't receive detailed error messages. "+
